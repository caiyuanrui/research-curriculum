...
系统性的研究学习笔记 — 每日一篇论文，追踪 AI 各领域发展脉络。
...
| [Multimodal Course](multimodal/index.md) | 周二 | 多模态学习：视觉-语言预训练到多模态大模型 |
...
!!! tip "探索"
    使用顶部的导航栏浏览各课程，或查看 [Timeline](timeline.md) / [Knowledge Graph](knowledge-graph.md) 获取全局视角。
